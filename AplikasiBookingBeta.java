...
public class AplikasiBookingBeta {
    ...
    static void daftarAkun() {
        ...
        String arrayUseername[] = new String[1];
        String arrayPassword[] = new String[1];
        int akunTerdaftar = 0;

        System.out.println("Selamat datang di aplikasi booking ruangan, silahkan isi data diri anda!\n");

        // input nama
        System.out.print("Nama lengkap: ");
        String namaDaftar = sc.nextLine();
        ...
        while (!isUsernameDaftar) {
            ...
            usernameDaftar = sc.nextLine();

            if (usernameDaftar.length() >= 8 ) {
                isUsernameDaftar = true;
            } else {
                System.out.println("Username minimal harus 8 huruf atau angka!\n");
            }
